...
public static class Graph {
  ...
  public static void Polyline(Plot plot) {
    ...
    var labelColor = (plot.LineColor & 0x00FFFFFF) | 0x88000000;
    ...
    if (plot.ShowYAxis) {
      ...
      var maxLabel = $"{scale:0.#}";
      drawList.AddText(new Vector2(cursorScreenPos.X + 3f, cursorScreenPos.Y), labelColor, maxLabel);

      // Min value label at the bottom of the Y-axis
      drawList.AddText(new Vector2(cursorScreenPos.X + 3f, cursorScreenPos.Y + height - 12f), labelColor, "0");
    }
