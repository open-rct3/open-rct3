...
public static class Terrain {
  ...
  /// <summary>
  /// Decodes every corner record in the given park's terrain grid, in on-disk order. Corner
  /// count, and therefore grid dimensions, are derived from the blob's total size divided by
