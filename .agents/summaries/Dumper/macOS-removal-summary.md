...
The macOS client has been completely removed from the Dumper project, making it a Windows-only application. This
eliminates the maintenance burden of dual-platform support while focusing development on the WinForms-based Windows
client.
...
The macOS client removal was successful. The Dumper project is now a clean, Windows-only WinForms application with no
macOS dependencies. The build compiles without errors or warnings.
