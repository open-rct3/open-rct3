...
The user is deciding whether to continue maintaining the macOS platform for Dumper (an OVL file dumper tool). Currently
the project supports both Windows (WinForms) and macOS (AppKit) via conditional compilation.
