...
public class ParkLoadTests {
  ...
  [Test]
  public void World_Load_Rivendell_PopulatesParkAndTerrain() {
    ...
    testWorld.Load(rivendellPath);

    Assert.That(testWorld.Park, Is.Not.Null);
    Assert.That(testWorld.Terrain, Is.Not.Null);
    Assert.That(testWorld.Terrain!.GroundModel, Is.Not.Null);
  }

  [Test]
  public void World_Load_FunValley_PopulatesParkAndTerrain() {
