...
[`OpenCobra.Data.Dat`](../../../OpenCobra/Data/DAT.cs)), embedded into the `Tests` assembly so DAT parsing
...
Any `.dat` dropped under this tree is picked up automatically by [Tests.csproj](../../../OpenCobra/Tests/Tests.csproj)'s
